...
<rapid:override name="content">
    ...
    <form class="layui-form"  method="post" id="myForm" action="/admin/comment/replySubmit">
        ...
        <input type="hidden" name="commentPname" value="${comment.userName}">
        <input type="hidden" name="commentArticleId" value="${comment.articleId}">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="commentAuthorName"  value="诸葛财财" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">我的邮箱 </label>
            <div class="layui-input-block">
                <input type="text" name="commentAuthorEmail"  value="1146@qq.com" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">我的网址 </label>
            <div class="layui-input-block">
                <input type="text" name="commentAuthorUrl"  value="baidu.com" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
